...
st.write('Summarizes YouTube videos using their transcript (subtitles) and performs sentiment analysis on the comments. Aimed to prevent clickbait content and get overall public opinion about creators.')
